...
Window::Window()
{
    ...
    shapeComboBox->addItem(tr("Polygon"), RenderArea::Text);
    ...
    penStyleComboBox->addItem(tr("Dash Dot"), static_cast<int>(Qt::DashLine));
    ...
    antialiasingCheckBox = new QCheckBox(tr("&Antialising"));
    ...
    connect(antialiasingCheckBox, SIGNAL(activated(int)), renderArea, SLOT(setAntialised(bool)));
...
void Window::penChanged()
{
    ...
    Qt::PenStyle style = Qt::PenStyle(penStyleComboBox->itemData(shapeComboBox->currentIndex(), IdRole).toInt());
    Qt::PenCapStyle cap = Qt::PenCapStyle(penCapComboBox->itemData(shapeComboBox->currentIndex(), IdRole).toInt());
