...
int main(int argc, char *argv[])
{
    ...
    testShape1 = new Shape::Line(test,1,pen,brush,QPoint(50,50),QPoint(150,10));
    testShape2 = new Shape::Polyline(test,2,pen,brush,points1);
    testShape3 = new Shape::Polygon(test,3,pen,brush,points2);
